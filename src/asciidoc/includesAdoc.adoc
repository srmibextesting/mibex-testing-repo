...
Images should also work inside code sentences, image:logo.png[]  did it work? :)
Images no size attributes image:logo.png[]  did it work? :)
Images explict attributes, image:logo.png[]  did it work? :)
